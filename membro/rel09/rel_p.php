<?php
	...
	'Tela de impressao da listagem da recepcao de membros do distrito de $distrito_nome2 do ano $ano','$dados','pae_membro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    ...
    <tbody>
						...
						//ROL ANTERIOR
							...
							//RECEBIMENTOS
							$qr_rol_anterior = "SELECT distrito_id,sexo,ano_recepcao,
