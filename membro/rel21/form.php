...
<div class="panel panel-custom" id='loc'>
    <div class="panel-body">
        ...
        <h2 style="font-size:30px;padding-bottom:10px;color:#114a66"><strong><i class="fa fa-file-text"></i> EVOLU&Ccedil;&Atilde;O DE CRESCIMENTO DA REGI&Atilde;O POR IGREJA</strong></h2>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
...
<div class="panel panel-custom">
	...
	$conn = mysqli_connect($host, $user, $pass, $db); 
        ...
        <form  style='padding-top:20px;' name='contact-form' method='post' action='index.php?sessao=rel21'>
			...
			$('#id_categoria').change(function(){
				if( $(this).val() ) {
					...
					$.getJSON('busca_distrito.php?search=',{id_categoria: $(this).val(), ajax: 'true'}, function(j){
						var options = '<option value="">Escolha o distrito</option><option value="0">Todos</option>';	
