<?php
	...
	'Tela de impressao da listagem da Quantidade de membros da $regiao_nome no ano de $ano','$dados','pae_membro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            QUANTIDADE DE MEMBROS POR DISTRITO<?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
