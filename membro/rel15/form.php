...
<div class="panel panel-custom" id='loc'>
    <div class="panel-body">
        ...
        <h2 style="font-size:30px;padding-bottom:10px;color:#114a66"><strong><i class="fa fa-file-text"></i> ESTAT&Iacute;STICAS DE RECEP&Ccedil;&Atilde;O E DESLIGAMENTO POR REGI&Atilde;O (ANU&Ecirc;NIO)</strong></h2>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
...
<div class="panel panel-custom">
	...
	$conn = mysqli_connect($host, $user, $pass, $db); 
        ...
        <form  style='padding-top:20px;' name='contact-form' method='post' action='index.php?sessao=rel15'>
            ...
            <div class='col-md-4'>
                <div class='form-group'>
                    ...
                    <select name="id_categoria" id="id_categoria" class="form-control" required>
						...
						if ($nivel_user == "5" or $nivel_user == "7" or $nivel_user == "9") 
