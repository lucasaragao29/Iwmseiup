<?php
	...
	'Tela de impressao da listagem da recepcao de membros da IMW $igreja_nome do distrito de $distrito_nome2 do ano $ano','$dados','pae_membro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            ESTAT&Iacute;STICAS DE RECEP&Ccedil;&Atilde;O E DESLIGAMENTO<?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
...
<div class="panel panel-custom">
    ...
    <tbody>
						...
						//ROL ANTERIOR
							...
							//DESLIGAMENTOS
							$qr_rol_anterior_d = "SELECT sexo,distrito_id,ano_exclusao,
						...
						//RECEBIMENTOS
							...
							echo"<tr>
							<td colspan='5' style='font-size:15px;color:#fff;text-align:center;background:#000;'><b>RECEBIDOS
							</b></td>
							</tr>";
						...
						//DESLIGAMENTOS
							...
							echo"<tr>
							<td colspan='5' style='font-size:15px;color:#fff;text-align:center;background:#000;'><b>DESLIGAMENTOS
							</b></td></tr>";
