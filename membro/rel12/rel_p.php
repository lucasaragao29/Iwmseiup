...
<?php
	...
	//DESCRICAO
	$descricao_texto = " $regiao_nome2 - $ano_texto";
	...
	'Tela de impressao da listagem da Evolucao de Crescimento da $regiao_nome no
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            EVOLU&Ccedil;&Atilde;O DE CRESCIMENTO DA  <?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
            ...
            <div class="table-responsive">         
                <table class="table table-striped">
                    ...
                    <tr>
						...
						$ano  = $dados_anos["ano"];
						echo"<th style='text-align:right'><h2 style='font-size:15px;color:#000;'>
						<strong>$ano</strong></h2></th> ";
                ...
                <tbody>
                        ...
                        //DISTRITOS
                        $qr_distrito = "SELECT DISTINCT nome,id,regiao_id
						...
						$ano_periodo  = $dados_periodo["ano"];
							...
							$qr_data = "SELECT ano_recepcao,regiao_id,distrito_id,
							...
							$todos_data = mysql_query("$qr_data"); 
							while ($dados_data = mysql_fetch_array($todos_data)) {
							$recebidos  = $dados_data["recebidos"];
							$excluidos  = $dados_data["excluidos"];
							
							$rol_final = $recebidos-$excluidos;

							echo"<td style='font-size:13px;color:#333333;text-align:right'>$rol_final</td>";
							...
							$qr_data_porc = "SELECT ano_recepcao,regiao_id,distrito_id,
							...
							WHERE distrito_id='$distrito'
							AND	regiao_id = '$regiao'";
							$todos_data_porc  = mysql_query("$qr_data_porc "); 
							while ($dados_data_porc  = mysql_fetch_array($todos_data_porc )) {
							$recebidos_inicial = $dados_data_porc ["recebidos_inicial"];
							$excluidos_inicial = $dados_data_porc ["excluidos_inicial"];
							$recebidos_final   = $dados_data_porc ["recebidos_final"];
							$excluidos_final   = $dados_data_porc ["excluidos_final"];
							
							$rol_ano_inicial = $recebidos_inicial-$excluidos_inicial;
							$rol_ano_final = $recebidos_final-$excluidos_final;
							
							//////////PORCENTAGEM
							
							if ($rol_ano_inicial == $rol_ano_final) { $porcentagem = "0"; }
							else { 
						...
						echo"<td style='font-size:13px;color:#333333;text-align:center'>$porcentagem</td>
                        </tr>";
                    ...
                    <?php 
						...
						$ano_periodo  = $dados_periodo["ano"];
							...
							if ($rol_ano_inicial_t == $rol_ano_final_t) { $porcentagem = "0"; }
								...
								$porcentagem = (($rol_ano_final_t-$rol_ano_inicial_t)/$rol_ano_inicial_t)*100; 
								$porcentagem = number_format($porcentagem,2,'.','');
								
							
							}
							
							echo"<td style='font-size:13px;color:#333333;text-align:center'><b>$porcentagem</b></td>";
							 echo"</tr>";
						}		
