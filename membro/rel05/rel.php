...
<div class="panel panel-custom">
    <div class="panel-body">
		...
		//DESCRICAO
		$descricao_texto = "<br>DISTRITO $distrito_nome2 POR IGREJA - $ano_texto";
			...
			'Gerar listagem da Evolucao de Crescimento do distrito $distrito_nome por igreja da $regiao_nome no periodo de $anoi a $anof','$dados','pae_membro',
			curdate( ),curtime( ))";
		...
		?>
            ...
            <a href="rel05/rel_p.php?regiao=<?php echo"$regiao&distrito=$distrito&anoi=$anoi&anof=$anof";?>" 
