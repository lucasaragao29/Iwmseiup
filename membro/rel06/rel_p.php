<?php
	...
	'Tela de impressao da listagem da recepcao de membros por regiao do ano $ano','$dados','pae_membro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            RECEP&Ccedil;&Atilde;O DE MEMBROS GERAL <?php echo"- $ano"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
