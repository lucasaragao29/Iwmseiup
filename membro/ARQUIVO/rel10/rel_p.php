<?php
	...
	//DESCRICAO
	$descricao_texto = "DISTRITO DE $distrito_nome2 - $ano";
	...
	'Tela de impressao da listagem da estatistica de recepcao, desligamento e transferencia de membros do distrito de $distrito_nome2 do ano $ano','$dados','pae_membro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            ESTAT&Iacute;STICAS DE RECEP&Ccedil;&Atilde;O, DESLIGAMENTO E TRANSFER&Ecirc;NCIA<br><?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
...
<div class="panel panel-custom">
    ...
    <thead>
        <tr>
            ...
            <th style='text-align:center'><h2 style="font-size:15px;color:#3d3d3;"><strong>MASCULINO</strong></h2></th>
            <th style='text-align:center'><h2 style="font-size:15px;color:#3d3d3;"><strong>FEMININO</strong></h2></th>
            <th style='text-align:center'><h2 style="font-size:15px;color:#3d3d3;"><strong>N&Atilde;O INFORMADO</strong></h2></th>
            <th style='text-align:center'><h2 style="font-size:15px;color:#3d3d3;"><strong>TOTAL</strong></h2></th> 
        </tr>
    </thead> 
    <tbody>
					...
					$tr_anterior_total = $tr_anterior_m+$tr_anterior_f+$tr_anterior_n;
						...
						//RECEBIDOS
						 ...
						 echo"<tr>
                        <td colspan='5' style='font-size:15px;color:#3d3d3d;text-align:center;background:#fff;'><b>RECEBIDOS
						</b></td>
                        </tr>";
						...
						//RECEBIDOS
						 ...
						 echo"<tr>
                        <td colspan='5' style='font-size:15px;color:#3d3d3d;text-align:center;background:#fff;'><b>DESLIGAMENTOS
						</b></td>
                        </tr>";
