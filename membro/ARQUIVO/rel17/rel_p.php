<?php
	...
	'Tela de impressao da listagem da estatistica de recepcao, desligamento e transferencia de membros geral do ano $ano','$dados','pae_membro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            ESTAT&Iacute;STICAS DE RECEP&Ccedil;&Atilde;O,DESLIGAMENTO E<BR>TRANSFER&Ecirc;NCIA<br><?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
    ...
    <tbody>
					 ...
					 //DESLIGAMENTOS
						...
						$qr_rol_anterior_d = "SELECT sexo,status,regiao_id,modo_exclusao_id,dt_exclusao,
							  ...
							  COUNT(*) AS Total
							  FROM pae_membro 
							  WHERE modo_exclusao_id > '5' and status='I' 
