<?php
	...
	//DESCRICAO
	$descricao_texto = " DO DISTRITO DE $distrito_nome - $ano";
	...
	'Tela de impressao da listagem de Membros por departamento do distrito de $distrito_nome2 do ano $ano','$dados','pae_membro',
	curdate( ),curtime( ))";
