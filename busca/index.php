...
$qr_painel ="SELECT * from painel_opcoes where codigo='3'";
...
//CONTAR ACESSO
mysqli_query($conn,"UPDATE painel_opcoes SET contagem='$contar' WHERE codigo='3' ")
or die ("Erro ao adicionar Registro!!!" . mysqli_error());
...
<section id="services" class="service-item" style="background-color:#efefef;">
    <div class="container">
        ...
        <div class="panel panel-custom2">
                ...
                <div class="col-sm-6" align="center">
                    <div class="panel panel-custom2">
                        <div class="media " style="background-color:transparent;">
                            <div class="pull-left">
                                <img class="img-responsive" src="../imagens/icone_busca.png" 
                            ...
                            <div class="media-body" style="padding-top:20px;">
                                ...
                                <p style="color:#fff"  align="left">Pesquisa de membros e cl&eacute;rigos</p>                    
                            </div>
                        </div>
                    </div>
                </div>
			...
			$todos_usuario = mysqli_query($conn,"$qr_usuario"); 
			$tr_usuario = mysqli_num_rows($todos_usuario);
					
			include("config/opcao01.php");
