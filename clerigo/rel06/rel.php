<div class="panel panel-custom">
    <div class="panel-body">
		...
		$descricao_texto = " DE $mes2<br>$distrito_nome2 - $regiao_nome2";
			...
			'Gerar listagem de clerigos aniversariante do mes - $mes2 do distrito $distrito da $regiao_nome','$dados','pae_clerigo',
			curdate( ),curtime( ))";
		...
		?>
            ...
            <a href="rel06/rel_p.php?regiao=<?php echo"$regiao&distrito=$distrito&mes=$mes";?>" 
