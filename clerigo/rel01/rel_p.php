<?php
	...
	'Tela de impressao da listagem de clerigos $status Geral','$dados','pae_clerigo',
	curdate( ),curtime( ))";
...
<thead>
    <tr>
        ...
        <th style='text-align:left'><h2 style="font-size:15px;color:#114a66;"><strong>REGIA&Atilde;O</strong></h2></th>
                    ...
                    <tbody>
						...
						$data_atual = "$ano_atual-$mes_atual-$dia_atual";
							...
							FROM pae_clerigo
							WHERE status='$status' 
							AND regiao_id NOT IN ('962','12','26','2762')
