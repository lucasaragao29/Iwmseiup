<div class="panel panel-custom">
    <div class="panel-body">
		...
		//DESCRICAO
		$descricao_texto = " DE $mes2<br>GERAL";
			...
			'Gerar listagem de clerigos aniversariante do mes - $mes2 geral','$dados','pae_clerigo',
			curdate( ),curtime( ))";
		...
		?>
            ...
            <a href="rel04/rel_p.php?regiao=<?php echo"$regiao&mes=$mes";?>" 
...
<thead>
    ...
    <tbody>
						...
						$data_atual = "$ano_atual-$mes_atual-$dia_atual";
							...
							if ($mes == "0") { $mes_cod = ""; } else { $mes_cod = "MONTH(data_nascimento) = '$mes' AND";  }
							
							//LISTAGEM
							$qr_listagem = "SELECT DISTINCT nome,distrito_id,regiao_id,data_nascimento,distrito,regiao,
							MONTH(data_nascimento) as mes,DAY(data_nascimento) as dia
							FROM pae_clerigo
							WHERE $mes_cod  status='Ativo' and data_nascimento !='0000-00-00' and regiao_id !='962'
