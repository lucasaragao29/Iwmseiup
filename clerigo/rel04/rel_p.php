<?php
	...
	'Tela de impressao da listagem de clerigos aniversariante do mes - $mes2 da $regiao_nome','$dados','pae_clerigo',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            LISTAGEM DE CL&Eacute;RIGOS ANIVERSARIANTES <?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
