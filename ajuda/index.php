...
<?php 	
		...
		//MASTER - DIRETOR GERAL - REPRESENTANTE DO COLEGIO EPISCOPAL -SECRETARIO DE EDU&Ccedil;&Atilde;O CRISTA	
		if ($polo_user == "0" and $nivel_user == "1") { include("opcao01.php");}
	
		//DIRETOR DE POLO
		if ($polo_user > "0" and $nivel_user == "2")  { include("opcao02.php");}
		
		//SECRETARIA GERAL
		if ($polo_user == "0" and $nivel_user == "3")  { include("opcao02.php");}
		
		//SECRETARIA DE OPOLO
		if ($polo_user > "0" and $nivel_user == "3")  { include("opcao02.php");}
		
		//TESOUREIRO GERAL
		if ($polo_user == "0" and $nivel_user == "4") { include("opcao02.php");}
		
		//TESOUREIRO DO POLO
		if ($polo_user > "0" and $nivel_user == "4")  { include("opcao02.php");}
		
		//COORDENADORA PEDAGOGICA GERAL		
		if ($polo_user == "0" and $nivel_user == "5")  { include("opcao02.php");}
