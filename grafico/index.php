...
$qr_painel ="SELECT * from painel_opcoes where codigo='11'";
...
//CONTAR ACESSO
mysql_query("UPDATE painel_opcoes SET contagem='$contar' WHERE codigo='11' ")
                ...
                <div class="col-sm-6" align="center">
                    <div class="panel panel-custom2">
                        <div class="media " style="background-color:transparent;">
                            <div class="pull-left">
                                <img class="img-responsive" src="../imagens/icone_grafico.png" 
                            ...
                            <div class="media-body" style="padding-top:20px;">
                                ...
                                <strong>GR&Aacute;FICOS</strong></h2>
                                <p style="color:#fff"  align="left">Relat&oacute;rios com gr&aacute;ficos</p>                    
                            </div>
                        </div>
                    </div>
                </div>
