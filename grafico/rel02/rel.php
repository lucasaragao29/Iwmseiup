...
<div class="panel panel-custom">
    <div class="panel-body">
		...
		<?php
				...
				//TOTAL
				$qr_idade_t = "SELECT distrito_id,ano_recepcao,ano_exclusao,distrito,igreja,congregacao_id,congregacao,
				...
				$igreja_nome   = $dados_idade_t["igreja"];
				$congregacao   = $dados_idade_t["congregacao"];
				
				$nome = utf8_decode($congregacao);
				$igreja_nome = utf8_decode($igreja_nome);	
				
				$igreja_nome = str_replace("IMW ", "", $igreja_nome); 
					
				echo "['$nome ($igreja_nome)', $total],";
				}
