...
<div class="panel panel-custom" id='loc'>
    <div class="panel-body">
        ...
        <h2 style="font-size:30px;padding-bottom:10px;color:#114a66"><strong><i class="fa fa-file-text"></i>ESTAT&Iacute;STICA DE G&Ecirc;NERO POR DISTRITO</strong></h2>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
...
<div class="panel panel-custom">
    ...
    $conn = OpenCon(); ?>
        ...
        <form  style='padding-top:20px;' name='contact-form' method='post' action='index.php?sessao=rel20'>
...
//			$banco = mysql_select_db($db); 
			...
			echo"<select name='ano' class='form-control' required>";
				...
				$todos_ano = mysqli_query($conn, "$qr_ano"); 
				while ($dados_ano = mysqli_fetch_array($todos_ano)) {
