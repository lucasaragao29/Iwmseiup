...
<div class="panel panel-custom" id='loc'>
    <div class="panel-body">
        ...
        <h2 style="font-size:30px;padding-bottom:10px;color:#114a66"><strong><i class="fa fa-file-text"></i>ESTAT&Iacute;STICA DE G&Ecirc;NERO POR REGI&Atilde;O</strong></h2>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
