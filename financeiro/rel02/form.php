...
<div class="panel panel-custom" id='loc'>
    <div class="panel-body">
        ...
        <h2 style="font-size:30px;padding-bottom:10px;color:#114a66"><strong><i class="fa fa-file-text"></i> LIVRO RAZ&Atilde;O DE IGREJA</strong></h2>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
        ...
        <form  style='padding-top:20px;' name='contact-form' method='post' action='index.php?sessao=rel02'>
		   ...
		   echo"<div class='col-md-2'>
                <div class='form-group'>
                    ...
                    <input type='date' class='form-control' required name='datai'  max='$ano-$mes-$dia'> 
                </div>
            </div>
			...
			<div class='col-md-2'>
                <div class='form-group'>
                    ...
                    <input type='date' class='form-control' required name='dataf'  max='$ano-$mes-$dia'> 
                </div>
            </div>";
