<?php
	...
	'Tela de impressao relatorio do IRRF das igrejas do distrito $distrito_nome
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            IRRF<?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
            ...
            <div class="table-responsive">         
                <table class="table table-striped">
						...
						echo"<thead  >
							...
							<tr >
							<th style='text-align:left'><h2 style='font-size:15px;color:#000;'><strong>COD</strong></h2></th>
							<th style='text-align:left'><h2 style='font-size:15px;color:#000;'><strong>CONTA</strong></h2></th>
							<th style='text-align:right'><h2 style='font-size:15px;color:#000;'><strong>IRRF</strong></h2></th> 
							</tr>
						</thead> 
						<tbody>";
					    ...
					    FROM pae_financeiro
					    WHERE numeracao IN ('1.07.01','2.18.11')
