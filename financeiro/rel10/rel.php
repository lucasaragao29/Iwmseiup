<div class="panel panel-custom">
    <div class="panel-body">
		...
		$descricao_texto = "<br>DISTRITO DE $distrito_nome2 - $regiao_nome<br>PERIODO $datai_t a $dataf_t";
			...
			'Gerar relatorio do IRRF das igrejas do distrito $distrito_nome
		...
		?>
            ...
            IRRF<?php echo"$descricao_texto"; ?></strong><br>
            ...
            <a href="rel10/rel_p.php?distrito=<?php echo"$distrito&igreja=$igreja&datai=$datai&dataf=$dataf";?>" 
            ...
            <div class="table-responsive">         
                <table class="table table-striped">
						...
						echo"<thead  >
							...
							<th style='text-align:right'><h2 style='font-size:15px;color:#114a66;'><strong>IRRF</strong></h2></th> 
							</tr>
						</thead> 
						<tbody>";
