<?php
	...
	//DESCRICAO
	$descricao_texto = " DISTRITO DE $distrito_nome2 - $regiao_nome - $ano";
	...
	'Tela de impressao do relatorio do investimento clerigo 2 do distrito $distrito_nome da $regiao_nome do ano de $ano','$dados','pae_financeiro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            INVESTIMENTO EM CL&Eacute;RIGO II <?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
