<?php
	...
	'Tela de impressao relatorio do dizimo pastoral das igrejas do distrito $distrito_nome
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            D&Iacute;ZIMO PASTORAL<?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
            ...
            <div class="table-responsive">         
                <table class="table table-striped">
						...
						echo"<tbody >
							...
							<td style='text-align:right'><h2 style='font-size:15px;color:#000;'><strong>D&Iacute;ZIMO	</strong></h2></th> 
							</tr>
						</tbody>
						<tbody>";
					    ...
					    FROM pae_financeiro
					    WHERE numeracao IN ('1.01.03','1.01.04','1.01.05')
						...
						echo"<tbody >
							...
							<tr >
							<td style='text-align:left'><h2 style='font-size:15px;color:#114a66;'><strong>COD</strong></h2></th>
							<td style='text-align:left'><h2 style='font-size:15px;color:#114a66;'><strong>CONTA</strong></h2></th>
							<td style='text-align:right'><h2 style='font-size:15px;color:#114a66;'><strong>D&Iacute;ZIMO</strong></h2></th> 
							</tr>
						</tbody> 
						<tbody>";
