<?php
	...
	'Tela de impressao do relatorio do tiquete medio de investimenro em clerigo da $regiao_nome do ano de $ano','$dados','pae_financeiro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            T&Iacute;QUETE M&Eacute;DIO DE INVESTIMENTO POR CL&Eacute;RIGO DA <?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
