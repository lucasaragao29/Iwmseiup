...
<div class="panel panel-custom" id='loc'>
    <div class="panel-body">
        ...
        <h2 style="font-size:30px;padding-bottom:10px;color:#114a66"><strong><i class="fa fa-file-text"></i> T&Iacute;QUETE M&Eacute;DIO DE INVESTIMENTO POR CL&Eacute;RIGO DA REGI&Atilde;O</strong></h2>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
...
<div class="panel panel-custom">
	...
	$conn = mysqli_connect($host, $user, $pass, $db);
        ...
        <form  style='padding-top:20px;' name='contact-form' method='post' action='index.php?sessao=rel11'>
            ...
            <div class='col-md-5'>
                <div class='form-group'>
                    ...
                    <select name="id_categoria" id="id_categoria" class="form-control" required>
						...
						FROM pae_regiao
						WHERE id !='26' and id !='2762' and id !='962' $regiao_filtro
						ORDER BY nome ASC
						";
