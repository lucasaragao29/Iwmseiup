...
<div class="panel panel-custom" id='loc'>
    <div class="panel-body">
        ...
        <h2 style="font-size:30px;padding-bottom:10px;color:#114a66"><strong><i class="fa fa-file-text"></i> INVESTIMENTO EM CL&Eacute;RIGO I</strong></h2>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
        ...
        <form  style='padding-top:20px;' name='contact-form' method='post' action='index.php?sessao=rel14'>
		   ...
		   echo"<div class='col-md-3'>
                <div class='form-group'>
                    ...
                    <input type='month' class='form-control' required name='datai'  min='2010-01' max='$ano-$mes'> 
                </div>
            </div>
			...
			<div class='col-md-3'>
                <div class='form-group'>
                    ...
                    <input type='month' class='form-control' required name='dataf' min='2010-01' max='$ano-$mes'> 
                </div>
            </div>";
