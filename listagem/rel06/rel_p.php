<?php
	...
	//DESCRICAO
	$descricao_texto = "<br>$regiao_nome2";
	...
	'Tela de impressao da listagem de distritos da regiao $regiao_nome','$dados','pae_membro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            LISTAGEM DE DISTRITOS<?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
...
<thead>
    <tr>
        <th><h2 style="font-size:15px;color:#000;"><strong></strong></h2></th>
        <th style='text-align:left'><h2 style="font-size:15px;color:#000;"><strong>DISTRITO</strong></h2></th>
                    ...
                    <tbody>
						...
						$data_atual = "$ano_atual-$mes_atual-$dia_atual";
							...
							//LISTAGEM
							$qr_listagem = "SELECT DISTINCT nome,regiao_id FROM pae_distrito
