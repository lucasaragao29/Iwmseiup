<?php
	...
	'Tela de impressao da listagem de igrejas da regiao $regiao_nome','$dados','pae_membro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            LISTAGEM DE IGREJAS<?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
        ...
        <th style='text-align:left'><h2 style="font-size:15px;color:#000;"><strong>DISTRITO</strong></h2></th>
                    ...
                    <tbody>
						...
						$data_atual = "$ano_atual-$mes_atual-$dia_atual";
							...
							//LISTAGEM
							$qr_listagem = "SELECT DISTINCT nome,distrito,regiao_id FROM pae_igreja
