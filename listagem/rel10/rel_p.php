<?php
	...
	'Tela de impressao de membros da $igreja_nome do distrito de $distrito_nome da $regiao_nome','$dados','pae_membro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    ...
    <thead>
        <tr>
            ...
            <th style='text-align:left'><h2 style="font-size:13px;color:#000;"><strong>NOME</strong></h2></th>
            <th style='text-align:left'><h2 style="font-size:13px;color:#000;"><strong>DATA DE NASCIMENTO</strong></h2></th>
