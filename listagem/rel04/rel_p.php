<?php
	...
	'Tela de impressao da listagem de congregacoes do distrito $distrito_nome da $regiao_nome','$dados','pae_membro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            LISTAGEM DE CONGREGA&Ccedil;&Otilde;ES<?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
...
<thead>
    <tr>
        ...
        <th style='text-align:left'><h2 style="font-size:15px;color:#000;"><strong>CONGREGA&Ccedil;&Atilde;O</strong></h2></th>
        <th style='text-align:left'><h2 style="font-size:15px;color:#000;"><strong>IGREJA</strong></h2></th>
                    ...
                    <tbody>
						...
						$data_atual = "$ano_atual-$mes_atual-$dia_atual";
							...
							//LISTAGEM
							$qr_listagem = "SELECT DISTINCT nome,distrito,regiao_id,igreja
							FROM pae_congregacao
							WHERE distrito_id='$distrito' 
							ORDER BY igreja asc, nome asc";
							$i="0";
