<div class="panel panel-custom">
    <div class="panel-body">
		...
		$descricao_texto = "<br>DISTRITO DE $distrito_nome2 - $regiao_nome2";
			...
			'Gerar listagem de congregacoes do distrito $distrito_nome da $regiao_nome','$dados','pae_membro',
			curdate( ),curtime( ))";
		...
		?>
            ...
            LISTAGEM DE CONGREGA&Ccedil;&Otilde;ES<?php echo"$descricao_texto"; ?></strong><br>
            ...
            <a href="rel04/rel_p.php?regiao=<?php echo"$regiao&distrito=$distrito";?>" 
