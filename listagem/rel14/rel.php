<div class="panel panel-custom">
    <div class="panel-body">
		...
		//DESCRICAO
		$descricao_texto = "<br>DISTRITO $distrito_nome2 - $regiao_nome";
			...
			'Gerar listagem fiscal do distrito $distrino_nome da $regiao_nome','$dados','pae_nomeacao',
			curdate( ),curtime( ))";
		...
		?>
            ...
            <a href="rel14/rel_p.php?regiao=<?php echo"$regiao&distrito=$distrito";?>" 
...
<div class="panel panel-custom">
    <div class="panel-body">
       ...
       <?php
		...
		echo"<thead >
		<tr bgcolor='#114a66'>
		<th colspan='4' style='text-align:center'><h2 style='font-size:15px;color:#fff;'><strong>$nome - $igreja</strong></h2></th>
		</tr>";
