<div class="panel panel-custom">
    <div class="panel-body">
		...
		//DESCRICAO
		$descricao_texto = "<br>$funcao_nome2 - $regiao_nome";
			...
			'Gerar listagem de clerigos ($funcao_nome) da $regiao_nome','$dados','pae_nomeacao',
			curdate( ),curtime( ))";
		...
		?>
            ...
            <a href="rel08/rel_p.php?regiao=<?php echo"$regiao&funcao=$funcao";?>" 
        ...
        <div class="col-sm-12">
            ...
            <thead>
                <tr>
                    ...
                    <th style='text-align:left'><h2 style="font-size:15px;color:#114a66;"><strong>ANIVERS&Aacute;RIO</strong></h2></th>
