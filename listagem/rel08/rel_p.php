<?php
	...
	'Tela de impressao da listagem  de clerigos ($funcao_nome) da $regiao_nome','$dados','pae_clerigo',
	curdate( ),curtime( ))";
        ...
        <div class="col-sm-12">
            ...
            <thead>
                <tr>
                    ...
                    <th style='text-align:left'><h2 style="font-size:15px;color:#000;"><strong>ANIVERS&Aacute;RIO</strong></h2></th>
