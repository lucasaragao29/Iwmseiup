<?php
	...
	$regiao   = $_GET["regiao"];
		...
		//DESCRICAO
		$descricao_texto = "($funcao_nome2)<br>DISTRITO DE $distrito_nome2 - $regiao_nome";
	...
	'Tela de impressao da listagem  de clerigos ($funcao_nome) do distrito $distrito_nome','$dados','pae_clerigo',
	curdate( ),curtime( ))";
