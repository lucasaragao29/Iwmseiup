...
$qr_painel ="SELECT * from painel_opcoes where codigo='8'";
...
//CONTAR ACESSO
mysql_query("UPDATE painel_opcoes SET contagem='$contar' WHERE codigo='8' ")
                ...
                <div class="col-sm-6" align="center">
                    <div class="panel panel-custom2">
                        <div class="media " style="background-color:transparent;">
                            <div class="pull-left">
                                <img class="img-responsive" src="../imagens/icone_relatorio.png" 
                                style="border:white 4px solid; background-color:white;border-radius: 100px;">
                            </div>
                            <div class="media-body" style="padding-top:20px;">
                                <h2 class="media-heading" style="font-size:<?php echo"$fonte_titulo"; ?>;color:#fff" align="left"><strong>LISTAGEM</strong></h2>
                                <p style="color:#fff"  align="left">Relat&oacute;rios de listagem</p>                    
                            </div>
                        </div>
                    </div>
                </div>
