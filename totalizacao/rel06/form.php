...
<div class="panel panel-custom" id='loc'>
    <div class="panel-body">
        ...
        <h2 style="font-size:30px;padding-bottom:10px;color:#114a66"><strong><i class="fa fa-file-text"></i> 10 MAIORES IGREJAS</strong></h2>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
...
<div class="panel panel-custom">
	...
	$conn = mysqli_connect($host, $user, $pass, $db); 
        ...
        <form  style='padding-top:20px;' name='contact-form' method='post' action='index.php?sessao=rel06'>
            ...
            <div class='col-md-3'>
                <div class='form-group'>
                    ...
                    <select name="id_categoria" id="id_categoria" class="form-control" required>
						...
						else { echo"<option value=''>Selecione</option><option value='0'>Geral</option>"; }
