...
<div class="panel panel-custom" id='loc'>
    <div class="panel-body">
        ...
        <h2 style="font-size:30px;padding-bottom:10px;color:#114a66"><strong><i class="fa fa-file-text"></i> TOTALIZA&Ccedil;&Atilde;O DE MEMBROS + CL&Eacute;RIGOS</strong></h2>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
