<?php
	...
	'Tela de impressao da listagem dos 10 maiores distritos da $regiao_nome do ano $ano','$dados','pae_membro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            10 MAIORES DISTRITOS <?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
            ...
            <div class="table-responsive">         
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th style='text-align:left'><h2 style="font-size:13px;color:#000;"><strong>MEMBROS</strong></h2></th>
                    </tr>
                </thead> 
                    <tbody>
