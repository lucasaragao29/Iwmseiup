 ...
 <?php 
	 ...
	 if ($regiao == "0") {               
		...
		<tr>
			...
			<th style='text-align:left'><h2 style='font-size:15px;color:#114a66;'><strong>DISTRITOS</strong></h2></th>
		</tr>
		</thead>"; 
	 }
...
?>
    <tbody>
		...
		if ($regiao == "0") {
            ...
            <td style='font-size:13px;color:#333333;text-align:left'>$tr_distrito</td>
            </tr>";
            ...
            <td style='font-size:13px;color:#333333;text-align:left'><strong>$tr_distrito</strong></td>
            </tr>";
