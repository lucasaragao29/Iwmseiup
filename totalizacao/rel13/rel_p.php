<?php
	...
	$GRAVAR = "INSERT INTO historico_usuario
		...
		'Tela de impressao da listagem das 10 distritos que mais cresceram na $regiao_nome no periodo de $anoi a $anof','$dados','pae_membro',
		curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            10 DISTRITOS QUE MAIS CRESCERAM - <?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
