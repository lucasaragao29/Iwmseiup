<div class="panel panel-custom">
    <div class="panel-body">
		...
		'Gerar listagem das 10 distritos que mais cresceram na $regiao_nome no periodo de $anoi a $anof','$dados','pae_membro',
		curdate( ),curtime( ))";
		...
		?>
            ...
            10 DISTRITOS QUE MAIS CRESCERAM<?php echo"$descricao_texto"; ?></strong><br>
            ...
            <a href="rel13/rel_p.php?regiao=<?php echo"$regiao&anoi=$anoi&anof=$anof";?>" 
...
<div class="panel panel-custom">
    ...
    <tbody>
		...
		<?php 
			...
			//MEMBROS
			$qr_membros = "SELECT regiao_id, igreja_id, ano_recepcao,ano_exclusao,distrito,regiao,igreja,distrito_id,
