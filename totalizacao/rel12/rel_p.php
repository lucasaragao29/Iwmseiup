<?php
	...
	'Tela de impressao das 10 distritos que mais batizaram na $regiao_nome em $ano','$dados','pae_membro',
	curdate( ),curtime( ))";
...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            10 DISTRITOS QUE MAIS BATIZARAM<?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
...
<div class="panel panel-custom">
 ...
 <?php 
		...
		<tr>
			...
			<th style='text-align:left'><h2 style='font-size:15px;color:#000;'><strong>MEMBROS</strong></h2></th>
		</tr>
		</thead>"; 
