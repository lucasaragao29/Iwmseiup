<div class="panel panel-custom">
    <div class="panel-body">
		...
		$descricao_texto = "<br> $regiao_nome2 - $ano";
			...
			'Gerar listagem das 10 distritos que mais batizaram na $regiao_nome em $ano','$dados','pae_membro',
			curdate( ),curtime( ))";
		...
		?>
            ...
            10 DISTRITOS QUE MAIS BATIZARAM<?php echo"$descricao_texto"; ?></strong><br>
            ...
            <a href="rel12/rel_p.php?regiao=<?php echo"$regiao&ano=$ano";?>" 
...
<div class="panel panel-custom">
 ...
 <?php 
		...
		<tr>
			...
			<th style='text-align:left'><h2 style='font-size:15px;color:#114a66;'><strong>MEMBROS</strong></h2></th>
		</tr>
		</thead>"; 
...
?>
    <tbody>
		...
		<?php 
			...
			SUM(CASE WHEN modo_recepcao_id ='1' then 1 ELSE 0 END) AS recebidos,
			COUNT(*) AS Total	
			FROM pae_membro
            ...
            <td style='font-size:13px;color:#333333;text-align:left'>$regiao</td>
			 <td style='font-size:13px;color:#333333;text-align:left'>$recebidos</td>
            </tr>";
