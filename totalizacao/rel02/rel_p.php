...
<div class="panel panel-custom">
    <div class="panel-body">
        <div class="col-sm-12" align="CENTER">
            ...
            TOTALIZA&Ccedil;&Atilde;O DE CONGREGA&Ccedil;&Otilde;ES  <?php echo"$descricao_texto"; ?></strong></p>
        </div> <!-- col-sm-12 -->  
    </div> <!-- panel-body -->
 ...
 <?php 
	 ...
	 if ($regiao == "0") {               
		...
		<tr>
			...
			<th style='text-align:right'><h2 style='font-size:15px;color:#000;'><strong>CONGREGA&Ccedil;&Otilde;ES</strong></h2></th>
		</tr>
		</thead>"; 
	 }
