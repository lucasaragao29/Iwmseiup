<div class="panel panel-custom">
    <div class="panel-body">
		...
		$descricao_texto = "$regiao_nome2";
			...
			'Gerar listagem de totalizacao de congregacoes - $regiao_nome','$dados','pae_igreja',
			curdate( ),curtime( ))";
		...
		?>
            ...
            TOTALIZA&Ccedil;&Atilde;O DE CONGREGA&Ccedil;&Otilde;ES <?php echo"$descricao_texto"; ?></strong><br>
            ...
            <a href="rel02/rel_p.php?regiao=<?php echo"$regiao";?>" 
 ...
 <?php 
	 ...
	 if ($regiao == "0") {               
		...
		<tr>
			...
			<th style='text-align:left'><h2 style='font-size:15px;color:#114a66;'><strong>CONGREGA&Ccedil;&Otilde;ES</strong></h2></th>
		</tr>
		</thead>"; 
	 }
